...
{
 public:
  static H264LiveServerMediaSession* createNew(UsageEnvironment& env, bool reuseFirstSource, NVTSYS::VideoEncoder& streamVenc);
  void checkForAuxSDPLine1();
  void afterPlayingDummy1();
 protected:
  H264LiveServerMediaSession(UsageEnvironment& env, bool reuseFirstSource, NVTSYS::VideoEncoder& streamVenc);
 ...
 private:
    NVTSYS::VideoEncoder& streamVenc;
  char* fAuxSDPLine;
  char fDoneFlag;
  RTPSink* fDummySink;
};
