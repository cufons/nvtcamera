...
H264LiveServerMediaSession::createNew(UsageEnvironment& env,
                                      bool reuseFirstSource, NVTSYS::VideoEncoder& streamVenc)
{
  return new H264LiveServerMediaSession(env, reuseFirstSource,streamVenc);
}
                                                  ...
                                                  unsigned& estBitRate)
{
  ...
  estBitRate = 8000000;
  VencLiveSourceH264 *source = VencLiveSourceH264::createNew(envir(),streamVenc);
  /* comments from original source code*/
